...
// Generated at Sun May 6 10:09:52 PM.
...
func TestMemoryFS_TestWrite100MBytes(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        fsraft.TestWrite100MBytes(t, &mfs)
}
...
func TestMemoryFS_TestWriteRead8Bytes(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        fsraft.TestWriteRead8Bytes(t, &mfs)
}
...
func TestMemoryFS_TestWrite1Byte(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        fsraft.TestWrite1Byte(t, &mfs)
}

func TestMemoryFS_TestWrite10MBytes(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        fsraft.TestWrite10MBytes(t, &mfs)
}
...
func TestMemoryFS_TestWriteRead1Byte(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        fsraft.TestWriteRead1Byte(t, &mfs)
}
