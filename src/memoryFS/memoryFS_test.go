...
// Generated at Thu May 10 9:19:54 AM.
...
func TestMemoryFS_TestWriteRead64KBIter10MB(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        filesystem.TestWriteRead64KBIter10MB(t, &mfs)
}

func TestMemoryFS_TestWriteRead64KBIter1MB(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        filesystem.TestWriteRead64KBIter1MB(t, &mfs)
}
...
func TestMemoryFS_TestWriteRead8BytesSimple(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        filesystem.TestWriteRead8BytesSimple(t, &mfs)
}

func TestMemoryFS_TestWriteRead64BytesIter64K(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        filesystem.TestWriteRead64BytesIter64K(t, &mfs)
}
...
func TestMemoryFS_TestWriteRead1MBIter100MB(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        filesystem.TestWriteRead1MBIter100MB(t, &mfs)
}
...
func TestMemoryFS_TestWriteRead1ByteSimple(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        filesystem.TestWriteRead1ByteSimple(t, &mfs)
}

func TestMemoryFS_TestWriteRead8BytesIter8(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        filesystem.TestWriteRead8BytesIter8(t, &mfs)
}

func TestMemoryFS_TestWriteRead8BytesIter64(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        filesystem.TestWriteRead8BytesIter64(t, &mfs)
}
...
func TestMemoryFS_TestHelpGenerateJenkinsPipeline(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        filesystem.TestHelpGenerateJenkinsPipeline(t, &mfs)
}
...
func TestMemoryFS_TestWriteRead64BytesSimple(t *testing.T) {
	mfs := CreateEmptyMemoryFS()
        filesystem.TestWriteRead64BytesSimple(t, &mfs)
}
