...
run_test "TestMemoryFS_TestRndWriteRead640BytesIter64K" 1
...
run_test "TestClerk_OneClerkThreeServersNoErrors_TestRndWriteRead640BytesIter64K" 1
...
run_test "TestClerk_OneClerkFiveServersUnreliableNet_TestRndWriteRead640BytesIter64K" 1
